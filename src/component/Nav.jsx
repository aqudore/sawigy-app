...
function Nav(){
    ...
    <div className=" w-full h-20 shadow-md text-white p-4  flex justify-center  items-center flex- row   gap-10">
        <div  className=" flex justify-center  items-center flex-row gap-40">
         ...
         <div className=" flex justify-center  items-center flex-row gap-7">
           ...
           <div className="flex justify-center  items-center flex- row gap-3">
              <p className=" caret-lime-5 text-black  shadow-md">Other </p>
              <h1  className="  text-orange-400 text-2xl px-1 py-">v</h1>
            </div>
              
          </div>
       

               <div  className="flex justify-center  items-center flex- row    gap-15">

                  <div className=" flex justify-center  items-center flex- row gap-5  ">
                    <p className=" text-black font-bold text-2xl">*</p>
                     <p className= " text-black">swigy cooprate </p>
                  </div>

                <div className=" flex justify-center  items-center flex- row gap-5 ">
                  <p className=" text-black font-bold text-2xl">+</p>
                  <p className="  text-black">searech  </p>
               </div>
